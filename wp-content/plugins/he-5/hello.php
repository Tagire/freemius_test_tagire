<?php
	...
	*/
    ...
    if ( ! function_exists( 'sdt_fs' ) ) {
        ...
        function sdt_fs() {
            ...
            if ( ! isset( $sdt_fs ) ) {
                ...
                $sdt_fs = fs_dynamic_init( array(
                    'id'                  => '5129',
                    'slug'                => 'super-dolly-takhir',
                    'type'                => 'plugin',
                    'public_key'          => 'pk_8c18f1771f5a33c577cd20cb3a526',
                    'is_premium'          => true,
	...
	function hello_dolly_get_songs()
	{
        ...
        if ( sdt_fs()->is__premium_only() ) {
            if ( sdt_fs()->can_use_premium_code() ) {
                if (sdt_fs()->is_plan('summertime')) {
                    $songs[] = 'Summertime';
                }
                $songs[] = 'Wonderful World';
                if (sdt_fs()->is_plan('buisness')) {
